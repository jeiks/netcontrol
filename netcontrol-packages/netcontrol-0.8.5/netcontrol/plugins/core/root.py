...
from netcontrol.api import ICategoryProvider, EventProcessor, SessionPlugin, event, URLHandler, url, get_environment_vars
from netcontrol.ui import BasicTemplate
from netcontrol.utils import ConfigurationError
...
class RootDispatcher(URLHandler, SessionPlugin, EventProcessor, Plugin):
    ...
    def is_firstrun(self):
        if not self.app.gconfig.has_option('netcontrol', 'firstrun'):
            return True
