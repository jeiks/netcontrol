<xsl:template match="topcategory">
    <a class="ui-el-top-category{x:iif(@selected, ' selected', '')}" href="#" onclick="return Netcontrol.selectCategory('{@id}');" id="{@id}">
...
<xsl:template match="category">
    <a href="#" onclick="return Netcontrol.selectCategory('{@id}');">
