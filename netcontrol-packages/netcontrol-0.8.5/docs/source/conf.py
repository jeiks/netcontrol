# -*- coding: utf-8 -*-
#
# Netcontrol documentation build configuration file, created by
...
htmlhelp_basename = 'Netcontroldoc'
...
latex_documents = [
  ('index', 'Netcontrol.tex', u'Netcontrol Documentation',
...
man_pages = [
    ('index', 'netcontrol', u'Netcontrol Documentation',
     [u'Eugeny Pankov'], 1)
]
