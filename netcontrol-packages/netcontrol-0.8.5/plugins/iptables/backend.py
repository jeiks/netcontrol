...
class Rule:
    ...
    def get_ui_text(self, param, help=''):
        ...
        return UI.HContainer(
                    UI.SelectInput(
                        UI.SelectOption(text='Ignorar', value='ign', selected=v[1] is None),
                        UI.SelectOption(text='é', value='nrm', selected=not v[0] and v[1] is not None),
                        UI.SelectOption(text='Não é', value='inv', selected=v[0] and v[1] is not None),
                        design='mini',
                        name='%s-mode'%param
                    ),
    ...
    def get_ui_bool(self, param):
        ...
        return UI.HContainer(
                    UI.SelectInput(
                        UI.SelectOption(text='Ignorar', value='ign', selected=v[1] is None),
                        UI.SelectOption(text='Sim', value='nrm', selected=v[1]==True),
                        UI.SelectOption(text='Não', value='inv', selected=v[1]==False),
                        design='mini',
                        name='%s-mode'%param
                    )
               )
